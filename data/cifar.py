...
class CIFAR100:
    def __init__(self, args):
        ...
        default_root = os.path.join(os.path.expanduser('~'), ".klass/data/cifar100")
        self.train_set = cifar.CIFAR100(args.get("train_dir", "data_dir", default_root), train=True, download=True)
        self.val_set = cifar.CIFAR100(args.get("val_dir", "data_dir", default_root), train=False, download=True)
        self.test_set = cifar.CIFAR100(args.get("test_dir", "data_dir", default_root), train=False, download=True)
